...
#BSUB -J gfp_embed_all_a3
#BSUB -o /home/labs/ginossar/talfis/LiveImaging/GFP_BF_Fusion/logs/gfp_embed_all_a3_%J.out
#BSUB -e /home/labs/ginossar/talfis/LiveImaging/GFP_BF_Fusion/logs/gfp_embed_all_a3_%J.err
#BSUB -n 4
